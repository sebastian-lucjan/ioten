export const rainbowColors = ['#D6A3A2', '#F1753B', '#ffd500', '#3300ff', '#861197'];
...
const theme = {
  ...
  gradient: {
    ...
    blueToTransparent: 'linear-gradient(180deg, hsl(0, 0%, 80%, 0) 0%, hsl(0, 0%, 80%, 0) 85%, hsl(0, 0%, 80%) 92.5%, #94b1f5 100%)',
